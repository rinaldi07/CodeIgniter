  ...
  <div class="container">
      ...
      <div class="row">
       ...
       <form action="<?php echo base_url(); ?>/Chekout/simpan_pesanan">
        <input type="hidden" name="" id="provinsi_asal" class="provinsi">
        ...
        <div class="form-group">
            ...
            <input type="text" name="customer_email" class="form-control"  disabled="" value="<?php echo $get_data_konsumen["customer_email"]; ?>">
        </div>
        <div class="form-group">
            <label >No Telepon</label>
            <input type="number" class="form-control"  disabled="" value="<?php echo $get_data_konsumen['customer_phone']; ?>">
        </div>

        <div class="form-group">
            <label >Provinsi Tujuan</label>
            <select onChange="get_kota_tujuan()" id="provinsi_tujuan" name="provinsi" class="form-control provinsi" required="" >
