  ...
  <div class="banner-bootom-w3-agileits">
    <div class="container">
        ...
        <ul class="uli">
          <?php foreach ($data_pembayaran as $row) { ?>
            <li>
              ...
              <strong class="angka">
                <p class="baba">BABASTUDIO296/<?= $row->pesanan_id; ?></p>
              </strong>
            </li>
            <li>
            ...
            <li>
              <font style="vertical-align:inherit; ">Batas Waktu Bayar</font>
              <div class="row">
              </div>
              <strong class="angka">
      ...
      <div class="jumbotron">
        ...
        <p><a class="btn btn-primary btn-lg" href="<?= base_url(); ?>Chekout/upload_bukti_pembayaran" role="button">UPLOAD BUKTI PEMBAYARAN</a></p>
        <p><a class="btn btn-primary btn-lg" href="<?php echo base_url(); ?>Chekout/cetak_invoice" role="button" target="_BLANK">Cetak Invoice</a></p>
      </div>
