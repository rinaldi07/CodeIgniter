    ...
    <div class="col-md-8 single-right-left ">
          ...
          <table class="table">
            ...
            <tbody>
                ...
                <td><a href="<?php echo base_url(); ?>/Home/hapusdatabelanja/<?php echo $item['rowid']; ?>" class="btn btn-sm btn-danger hapus-databelanja"><i class="glyphicon glyphicon-remove"></i></a></td>
              </tr>
              <tr>
                <?php } ?>
              ...
              <td colspan="4" align=""><b>Total Harga: Rp<?php echo number_format($grand_total,0,",","."); ?> &nbsp; </b>Jumlah Order: <?php echo $jumlah_qty; ?> </td>
              </tr>
            </tbody>
          </table>
      ...
      <style>
        .atas{margin-top: 40px;}
            ...
            data produk yang anda beli massih kosong !!!
            </div>";
        }
      ?>
    </div>
