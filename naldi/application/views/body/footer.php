...
<div class="footer">
	<div class="footer_agile_inner_info_w3l">
		...
		<div class="col-md-9 footer-right">
			<div class="sign-grds">
				...
				<div class="col-md-3 sign-gd flickr-post">
					...
					<ul>
						<li><a href="single.html"><img src="<?php echo base_url(); ?>asset/images/t1.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="<?php echo base_url(); ?>asset/images/t2.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="<?php echo base_url(); ?>asset/images/t3.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="<?php echo base_url(); ?>asset/images/t4.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="<?php echo base_url(); ?>asset/images/t1.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="<?php echo base_url(); ?>asset/images/t2.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="<?php echo base_url(); ?>asset/images/t3.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="<?php echo base_url(); ?>asset/images/t2.jpg" alt=" " class="img-responsive" /></a></li>
		...
		<p class="copy-right"> &copy;Rinaldi Wisna Paras.</p>
	</div>
</div>
<!-- //footer -->
...
<script type="text/javascript" src="<?php echo base_url(); ?>asset/js/sweetalert2.all.min.js"></script>
<!-- //js -->
...
<script src="<?php echo base_url(); ?>asset/js/easy-responsive-tabs.js"></script>
<script>
