	...
	<div class="container">
		...
		<div class="col-md-4 products-left">
			...
			<div class="css-treeview">
				...
				<ul class="tree-list-pad">
					...
					<li><a href="<?php echo base_url(); ?>kategori_produk/<?php echo $data["brand_name"]; ?>"><label for="item-0"><i class="fa fa-long-arrow-right" aria-hidden="true"></i><?php echo $data["brand_name"]; ?></a></label>
					</li>
					<?php } ?>
				</ul>
			</div>
		...
		<div class="col-md-8 products-right">
			...
			<div class="men-wear-top">
                ...
                <?php foreach($kategoribrand as $row) { ?>
