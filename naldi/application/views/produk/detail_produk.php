...
<div class="banner-bootom-w3-agileits">
	<div class="container">
	     <div class="col-md-4 single-right-left ">
			<div class="grid images_3_of_2">
				<div class="flexslider">
					<style>
						.titik{list-style: none;}
					</style>
					<ul class="slides">
						<li class="titik" data-thumb="<?php echo base_url(); ?>asset/images/<?php echo $detail["tshirt_image"] ?>">
							<div class="thumb-image"> <img src="<?php echo base_url(); ?>asset/images/<?php echo $detail["tshirt_image"] ?>" data-imagezoom="true" class="img-responsive"> </div>
						</li>
		...
		<div class="col-md-8 single-right-left simpleCart_shelfItem">
					<h3><?php echo $detail["tshirt_name"]; ?></h3>
					<p><span class="item_price">Rp.<?php echo number_format($detail["tshirt_price"],2, ",","."); ?></span> <del>Rp. <?php echo number_format($detail["harga_coret"],2, ",","."); ?></del></p>
					<div class="rating1">
					...
					<div class="color-quality">
						<div class="color-quality-right">
							<h5>Quality :</h5>
							<input type="number" name="qty" min="1" max="10" value="1" class="form-control" style="width: 240px !important;">
						</div>
					</div>
					   ...
					   <div class="tab1">
							...
							<div class="single_page_agile_its_w3ls">
							  <h6>Deskripsi Produk</h6>
							   ...
							   <p class="w3ls_para"><?php $detail["product_description"]; ?></p>
							</div>
						</div>
						<!--//tab_one-->
						<div class="tab2">
